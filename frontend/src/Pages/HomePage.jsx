        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="stats stats-vertical lg:stats-horizontal bg-base-100 shadow-lg">
              <div className="stat">
                <div className="stat-value text-primary">Interview-Ready</div>
                <div className="stat-title">Real Practice</div>
              ...
              <div className="stat">
                <div className="stat-value text-secondary">Structured</div>
                <div className="stat-title">Skill-Based Progress</div>
                <div className="stat-desc">
                  Start from basics → advanced problem solving
                </div>
              </div>

              <div className="stat">
                <div className="stat-value text-accent">Sharable</div>
                <div className="stat-title">Collab Sessions</div>
                <div className="stat-desc">
                  Walk through solutions together, asynchronously
                </div>
              </div>
            </div>
          </div>
